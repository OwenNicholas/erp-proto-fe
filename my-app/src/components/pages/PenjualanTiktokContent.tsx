...
const initialInvoices = [
  { invoice: "INV001", hargaSatuan: "Rp.250.000", jumlah: "1", discountPerItem: "0", total: "Rp.250.000" },
  { invoice: "INV002", hargaSatuan: "Rp.150.000", jumlah: "1", discountPerItem: "0", total: "Rp.150.000" },
];
...
export default function PenjualanTiktokContent() {
  ...
  const addRow = () => {
    setInvoices([
      ...invoices,
      { invoice: `INV00${invoices.length + 1}`, hargaSatuan: "Rp.0.000", jumlah: "0", discountPerItem: "0", total: "Rp.0.000" },
    ]);
  };
